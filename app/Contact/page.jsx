    ...
    return (
        <div>
            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-gray">Contact</h2>
            </div>
            ...
            <div class="container my-24 px-6 mx-auto">
                ...
                <section class="mb-32 text-gray-800">
                    ...
                    <div class="flex flex-wrap ">
                        <div class="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6  text-gray-500 sm:text-xl dark:text-black-400 text-3sm  lg:text-3md font-bold sm:text-xl">
                        ...
                        <div class="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
                            <form>
                                ...
                                <div class="form-group mb-6">
                                    <textarea class=" form block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleFormControlTextarea13" rows="3" placeholder="Message"></textarea>
                                </div>
